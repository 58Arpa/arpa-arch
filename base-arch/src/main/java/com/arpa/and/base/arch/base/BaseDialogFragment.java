...
import com.arpa.and.base.arch.R;
import com.arpa.and.base.arch.base.livedata.MessageEvent;
...
public abstract class BaseDialogFragment <VM extends BaseViewModel, VDB extends ViewDataBinding> extends DialogFragment implements IView<VM>, BaseNavigator {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (isBinding()) {
            viewBind = DataBindingUtil.bind(rootView);
            initViewModel();
        }
        return rootView;
    ...
    protected void registerLoadingEvent() {
        viewModel.getLoadingEvent().observe(getViewLifecycleOwner(), new Observer<Boolean>() {
            @Override
